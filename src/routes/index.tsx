  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 pt-20 sm:pt-28 md:pt-32">
      <div className="relative overflow-visible rounded-3xl glass p-3 sm:p-5 md:p-6">
        ...
        <div className="pointer-events-none absolute -top-20 right-2 z-30 flex flex-row-reverse items-end gap-2 sm:-top-28 sm:right-4 sm:gap-3 md:-top-32 md:right-6">
          <img
            src={mascotSitting}
            alt=""
            aria-hidden
          ...
          <div className="relative mb-6 hidden sm:block">
            <div className="rounded-2xl rounded-br-sm bg-white px-4 py-2 text-sm font-semibold text-foreground shadow-[var(--shadow-lift)] ring-1 ring-border md:text-base">
              👋 Welcome to <span className="text-primary">Finonest</span>!
            </div>
            <span className="absolute -right-1.5 bottom-2 h-3 w-3 rotate-45 bg-white ring-1 ring-border" />
          </div>
        </div>
        ...
        <div className="relative grid items-center gap-8 md:grid-cols-2">
          ...
          <div className="relative grid place-items-center" style={{ overflow: "visible" }}>
            ...
            <img
              ...
              aria-hidden
              loading="lazy"
              className="pointer-events-none absolute left-1/2 top-[18%] z-20 h-32 w-auto -translate-x-1/2 drop-shadow-[0_15px_25px_rgba(0,0,0,0.35)] sm:top-[20%] sm:h-40 md:top-[22%] md:h-48 lg:h-56"
            />
          </div>
        </div>
      </div>
  ...
  return (
    <div data-card className={`${TRIPLE_CARD} relative`} style={{ overflow: "visible" }}>
      <img
        ...
        aria-hidden
        loading="lazy"
        className="pointer-events-none absolute -top-12 right-2 z-30 h-20 w-auto drop-shadow-[0_15px_25px_rgba(0,0,0,0.3)] sm:-top-14 sm:right-3 sm:h-24 md:-top-16 md:h-28"
      />
