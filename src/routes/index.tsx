      ...
      <div className="relative overflow-visible rounded-3xl glass p-3 sm:p-5 md:p-6">
        ...
        <div className="pointer-events-none absolute -top-20 right-2 z-30 flex flex-row-reverse items-end gap-2 sm:-top-28 sm:right-4 sm:gap-3 md:-top-32 md:right-6">
          <img
            ...
            aria-hidden
            loading="lazy"
            className="h-24 w-auto -scale-x-100 drop-shadow-[0_18px_30px_rgba(0,0,0,0.35)] sm:h-32 md:h-36 lg:h-40"
          />
        ...
        <div className="relative grid items-center gap-8 md:grid-cols-2">
          ...
          <div className="relative grid place-items-center" style={{ overflow: "visible" }}>
            ...
            <img
              ...
              aria-hidden
              loading="lazy"
              className="pointer-events-none absolute left-1/2 top-[28%] z-20 h-20 w-auto -translate-x-1/2 drop-shadow-[0_15px_25px_rgba(0,0,0,0.35)] sm:top-[30%] sm:h-24 md:top-[32%] md:h-28 lg:h-32"
            />
          </div>
        </div>
      </div>
